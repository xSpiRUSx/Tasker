...
FILENAME_BY_KIND: dict[str, str] = {
    ...
    "routing_diagnostics": "01-routing-diagnostics.md",
    "routing_diagnostics_json": "01-routing-diagnostics.json",
    "clarification_request": "01-clarification-request.md",
    ...
    "scope_escalation": "09-scope-escalation.md",
